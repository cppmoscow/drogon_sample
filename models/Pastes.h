...
public:
   ...
   */
  explicit Pastes(const drogon::orm::Row &r,
  ...
  /**  For column code  */
  /// Get the value of the column code, returns the default value if the column
  /// is null
  ...
  /**  For column content  */
  /// Get the value of the column content, returns the default value if the
  /// column is null
  ...
  /**  For column token  */
  /// Get the value of the column token, returns the default value if the column
  /// is null
